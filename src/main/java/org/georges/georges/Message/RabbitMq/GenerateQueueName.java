...
private final RabbitQueueService rabbitQueueService = new RabbitQueueService(new RabbitMQConfig().rabbitAdmin(), new RabbitMQConfig().rabbitListenerEndpointRegistry(), new ApplicationContext() {
    @Override
    public String getId() {
        return null;
    }
